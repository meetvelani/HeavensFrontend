...
function FavoriteCakes() {
  return (
    <div className="ofc-main-div">
      <div className="heading-ofy">
        <h1 className="shop-heading">Favorite Cakes</h1>
          ...
          <div className="col-6 col-sm-4 col-md-3 col-xl-2">
            <div className="card-cake">
              ...
              <p className="badge-p-be">
                <span class="badge bg-light text-secondary">Red Velvet</span>{" "}
